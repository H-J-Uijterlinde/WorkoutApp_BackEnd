...
public class UserView {
    ...
    public UserView(Long id, String username, String email, Long workoutId, String referenceName, int numWeeks, int daysPerWeek, int currentDay) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.currentWorkout = new WorkoutView(workoutId, referenceName, numWeeks, daysPerWeek, currentDay);
    }
